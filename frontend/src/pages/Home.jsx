          ...
          <div className="flex h-full items-center justify-center">
            <div className="px-6  text-center text-white md:px-48">
              ...
              <h3 className="mb-8 text-xl">
                ...
                array of events curated just for you from concerts and sports to
                cultural gatherings. You next adventure awaits!
              </h3>
              <h3 className="mb-8 text-xl">
                Enjoy stress-free ticketing at your fingertips! Secure your spot
                effortlessly with our user-friendly platform. no more queues,
                just seamless event accress in a few clicks.
              </h3>
              <h3 className="mb-8 text-xl">
